...
public class PlayerMovement : MonoBehaviour
{
    ...
    private void OnAnimatorMove()
    {
        ...
        {
            m_rigidbody.velocity = Vector3.zero; // Use velocity for more direct control
            if (!IsFlying)
            {
                ...
                else
                {
                    ...
                    m_rigidbody.useGravity = true; // Re-enable gravity when landing
                }
        ...
        {
            if (m_rigidbody.position.x < Next_X_POS) // Corrected condition
